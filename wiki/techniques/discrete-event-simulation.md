...
tags: [discrete-event-simulation, event-scheduling, process-oriented, monte-carlo, random-variate-generation, output-analysis]
related_concepts: [discrete-event-systems, generalized-semi-markov-process, queueing-theory, perturbation-analysis]
