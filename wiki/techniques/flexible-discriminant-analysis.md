...
## Connections
- [[support-vector-machines]] — analogous-to: both fit a linear boundary in an enlarged basis space that maps to a nonlinear boundary in the original space
- [[optimal-scoring]] — uses: FDA is computed through the optimal-scoring algorithm
- [[linear-discriminant-analysis]] — generalizes: FDA generalizes LDA via flexible nonparametric regression in an enlarged space
