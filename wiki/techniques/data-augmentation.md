...
## Connections
- [[consistency-regularization]] — prerequisite-of
- [[simclr]] — prerequisite-of: Contrastive views in SimCLR are generated by data augmentation.
- [[regularization]] — instantiates: Augmentation injects invariance prior knowledge, acting as an implicit regularizer.
- [[empirical-risk-minimization]] — extends: Vicinal risk minimization replaces the point-mass empirical distribution with an algorithmically smoothed distribution p(x|x_n,A).