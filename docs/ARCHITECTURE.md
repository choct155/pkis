...
| **Agents** | Operating procedures for the maintenance roles. | [`LIBRARIAN.md`](LIBRARIAN.md), [`SYNTHESIZER.md`](SYNTHESIZER.md), [`MAINTENANCE.md`](MAINTENANCE.md), [`HYGIENIST.md`](HYGIENIST.md) |
